...
// import  { userMeQuery} from "../generated/graphql";
// import { isServer } from "../utils/isServer";

// export const NavBar: React.FC<> = ({}) => {
//   const [{fetching: logoutFetching}, logout] = userLogoutMutation()
//     const [{data, fetching}] = userMeQuery({
//         pause: isServer(),
//     });
    ...
    return (
        <div className={classes.HomePage}>
            <div className={classes.main_container}>
                ...
                <main className={classes.main_container}>Main
                </main>
            </div>
        </div>
